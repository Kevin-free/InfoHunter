...
export declare class TelegramClient extends TelegramBaseClient {
  ...
  updateTwoFaSettings({
    ...
    emailCodeCallback,
    onEmailCodeError
  }: twoFA.TwoFaParams): Promise<void>;
  /**
  ...
  ): Promise<import('../tl/custom/inlineResults').InlineResults>;
  /**
  ...
  ): messageMethods._MessagesIter | messageMethods._IDsIter;
  /**
  ...
  ): Promise<import('../Helpers').TotalList<Api.Message>>;
  /**
  ...
  getDialogs(
    ...
    import('../Helpers').TotalList<import('../tl/custom/dialog').Dialog>
  >;
  /**
  ...
  getParticipants(
    entity: EntityLike,
    params?: chatMethods.IterParticipantsParams
  ): Promise<import('../Helpers').TotalList<Api.User>>;
  /**
   ...
   */
  uploadFile(
    fileParams: uploadMethods.UploadFileParams
