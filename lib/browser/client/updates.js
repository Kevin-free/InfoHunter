...
exports._updateLoop =
  exports._dispatchUpdate =
  exports._processUpdate =
  exports._handleUpdate =
  exports.catchUp =
  exports.listEventHandlers =
  exports.removeEventHandler =
...
function _handleUpdate(client, update) {
  ...
  if (
    update instanceof tl_1.Api.Updates ||
    ...
    try {
      const ping = () => {
        return client._sender.send(
          new tl_1.Api.PingDelayDisconnect({
            pingId: (0, Helpers_1.returnBigInt)(
              (0, Helpers_1.getRandomInt)(
